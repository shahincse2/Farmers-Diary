                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/farmersdiary", "root", "");
                  //  System.out.println("congrats, db con established!----"+password);
                    ...
                    PreparedStatement st = (PreparedStatement) conn
                        .prepareStatement("Select phoneNo, password from sellermdiator where phoneNo=? and password=?");
                    ...
                    if (rs.next()) {
                        dispose();
                        new FB_Dashboard(mobile).setVisible(true);
                        this.setVisible(false);
                        
                    } else {
                        //JOptionPane.showMessageDialog(btnNewButton, "Wrong Username & Password");
                        label1.setText("Wrong password or username");
                       // System.out.println("");
                    }
                    conn.close();
