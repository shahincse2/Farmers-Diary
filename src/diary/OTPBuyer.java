...
public class OTPBuyer extends javax.swing.JFrame {
    ...
    String phone;
    int getOTP;
    public OTPBuyer(String p, int op) {
        initComponents();
        this.phone = p;
        this.getOTP = op;
            ...
            otpLabel.setText("Correct!"); 
              ...
              //pwd.setPassword(password.getPassword().toString());
                ...
                if(pws.length() == 2 || cpws.length() == 2){
                    ...
                    new CreateBuyerAcc(pass, phone).setVisible(true);
                }else{
...
//0192838474824
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OTPBuyer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
