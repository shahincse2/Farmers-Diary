 ...
 * @author shahi
 */
public class FB_DashboardBuyer extends javax.swing.JFrame {
   ...
   // private Connection conn;
    ...
    public FB_DashboardBuyer() {
        initComponents();
        
        
    }
    public FB_DashboardBuyer(String phone) {
        initComponents();
        this.phone = phone;
    ...
    try {
        ...
        conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/farmersdiary", "root", "");
           ...
           // model.addRow(new Object[]{roll, name, cl, sec});
            ...
            String tableItem = "select * from productgroup where buyerPhone="+phone;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        new Buyer_Calculate(phone).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FB_DashboardBuyer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FB_DashboardBuyer().setVisible(true);
            }
        });
    }
