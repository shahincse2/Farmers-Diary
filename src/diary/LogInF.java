...
public class LogInF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        label2.getAccessibleContext().setAccessibleName("jlabel2");
            ...
            try {
                conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/farmersdiary", "root", "");
                   //System.out.println("congrats, db con established!----"+password);
                    ...
                    PreparedStatement st = (PreparedStatement) conn.prepareStatement("Select phone, PASSWORD from farmers where phone=? and PASSWORD=?");
                    ...
                    if (rs.next()) {
                        dispose();
                        new FB_DashboardFarmers(mobile).setVisible(true);
                        this.setVisible(false);
                    } else {
                        label2.setText("Wrong password or username");
                    }
