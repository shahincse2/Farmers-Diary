...
public class CreateSellerMediator extends javax.swing.JFrame {

    /**
     * Creates new form CreateSellerMediator
     */
    String phoneNo, passwordPrev;
    public CreateSellerMediator() {
        initComponents();
        
    }
    
    public CreateSellerMediator(String pws, String phone) {
         initComponents();
       //  this();
    ...
    void returnObject(CreateSellerMediator obj){
        //dp = obj;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     //   char phoneValidation  = jTextField4.getText().charAt(0);
      ...
      try{
            ...
            String data = "INSERT INTO sellermdiator(fname, lname, gender, nid, birdthday, tredLicense, phoneNo, password) VALUES('"+fname+"', '"+lname+"', '"+gender+"', "+nid+", '"+birdthday+"', '"+tredLicense+"', '"+phone+"', '"+passwordPrev+"')";
    ...
    public static void main(String args[]) {
      ...
      //  System.out.println("The password is: "+ob.password);
        ...
        CreateSellerMediator dp = new CreateSellerMediator();
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateSellerMediator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new CreateSellerMediator().setVisible(true);
        });
