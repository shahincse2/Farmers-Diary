...
public class LogInB extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(99, 107, 126));
        setBounds(new java.awt.Rectangle(282, 100, 282, 100));

        jPanel1.setBackground(new java.awt.Color(204, 204, 204));

        jPanel2.setBackground(new java.awt.Color(6, 21, 64));
        ...
        jPanel3.setBackground(new java.awt.Color(238, 241, 248));
        ...
        jLabel4.setText("Don't have acccount?");

        jLabel5.setText("Welcome to Farmer's Dairy");
        ...
        if(mobile.isEmpty() || password.isEmpty()){
            ...
            try {
                conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/farmersdiary", "root", "");
                   // System.out.println("congrats, db con established!----"+password);
                    java.sql.Statement statement = conn.createStatement();
                    
                    PreparedStatement st = (PreparedStatement) conn
                        .prepareStatement("Select phone, password from buyer where phone=? and password=?");
                    ...
                    if (rs.next()) {
                        dispose();
                        new FB_DashboardBuyer(mobile).setVisible(true);
                        this.setVisible(false);
                        
//                        FB_Dashboard ah = new FB_Dashboard(mobile);
//                        ah.setTitle("Welcome");
//                        ah.setVisible(true);
...
//                    String data = "SELECT * FROM sellermdiator WHERE phoneNo = '"+mobile+"' && password = '"+password+"'";
//                    ResultSet getPws = statement.executeQuery(data);
//
//                    System.out.println("The password is:----- "+ getPws);
//                    System.out.println("Intuted password: "+password);
//                    if(getPws.next()){        
//                        this.setVisible(false);
//                        new Frontpage().setVisible(true);
//                    }else{
//                        System.out.println("Phone number and Password are inccorect");
//                    }
                    conn.close();
